...
export default function Header({ setDisplayState }: Header) {
  ...
  return (
    <div className="w-full h-12 bg-white shadow fixed top-0 left-0 flex justify-between items-center px-4">
      <div className="text-xl font-sans font-semibold ml-10 text-slate-700">MyNotes</div>
      <div className="flex justify-between items-center px-4">
        ...
        <div className="flex justify-center items-center gap-6">
          ...
          <button
            className="text-red-600 cursor-pointer border border-transparent hover:border-red-600 py-1 px-2 rounded hover:shadow transition hover:delay-100 hover:scale-3d text-sm sm:text-base"
